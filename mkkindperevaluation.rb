...
filename="data/Kind_to_Evaluation_Method.csv"
datadir="./figs/"
outputdir="diagrams/"
seperator="|"
...
auswahl=<<-eos
Industry Paper:no,yes

Evaluation Methods:Case Study,Questionnaire,Motivating Example,Experiment,Interview,Grounded Theory,Benchmark,Argumentation,Field Experiment,Mining Software Repositories,User Study,Literature Review,By Construction,Focus Group,Verification

eos

#texfile=outputdir+"kind_to_evaluation_histogram.tex"
#tex=open(texfile,"w+")
tex=nil
unless tex
 tex=STDOUT 
...
auswahl=<<-eos
Industry Paper:no,yes|Evaluation Methods:Case Study,Questionnaire,Motivating Example,Experiment,Interview,Grounded Theory,Benchmark,Argumentation,Field Experiment,Mining Software Repositories,User Study,Literature Review,By Construction,Focus Group,Verification

eos

#texfile=outputdir+"kind_to_evaluation_stacked.tex"
#tex=open(texfile,"w+")
tex=nil
unless tex
 tex=STDOUT 
...
auswahl=<<-eos
Evaluation Methods:Case Study,Questionnaire,Motivating Example,Experiment,Interview,Grounded Theory,Benchmark,Argumentation,Field Experiment,Mining Software Repositories,User Study,Literature Review,By Construction,Focus Group,Verification|Industry Paper:no,yes

Industry Paper:no,yes|Evaluation Methods:Case Study,Questionnaire,Motivating Example,Experiment,Interview,Grounded Theory,Benchmark,Argumentation,Field Experiment,Mining Software Repositories,User Study,Literature Review,By Construction,Focus Group,Verification

eos

#texfile=outputdir+"kind_to_evaluation_portfolio.tex"
#tex=open(texfile,"w+")
tex=nil
unless tex
 tex=STDOUT 
